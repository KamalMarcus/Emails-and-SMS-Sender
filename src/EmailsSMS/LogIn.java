...
public class LogIn extends javax.swing.JFrame {
  ...
  private void textPasswordKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textPasswordKeyReleased
    if (InputContext.getInstance().getLocale().toString().startsWith("ar")) {
      textPassword.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    }
    else{
      textPassword.setComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
    }
  ...
  private void checkAndLogIn() {
    String plaintext = String.valueOf( textPassword.getPassword() );
    

    try {
      if (EmailsAndSMSSender.content.equals(AESenc.encrypt(plaintext))) {
        dispose();
